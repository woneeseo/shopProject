		...
		<div class="row">
			<nav aria-label="Page navigation">
				<ul class="pagination">
					...
					<a href="/admin/product/list/${spt.curPage <= 1 ? 1 : spt.curPage-1}" aria-label="Previous"> 
					<span aria-hidden="true">
					&laquo;</span></a></c:if></li>
					<!--  << -->
					<c:forEach begin="${spt.beginPageNum}" end="${spt.stopPageNum}" var="idx">
						<li class="${spt.curPage == idx ? 'active' : ''}"><a href="/admin/product/list/${idx}">${idx}</a></li>
					...
					<a href="/admin/product/list/${spt.curPage >= spt.totalPage ? spt.totalPage : spt.curPage+1}" aria-label="Next">
