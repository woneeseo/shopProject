...
<body>
	...
	<div class="container">
		<div class="row">
			<h1 class="page-header">Q&A를 작성해주세요.</h1>
		</div>
		<div class="row" style="text-align: center;">
			<form class="form-horizontal" action="/board/insert" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" id="title" placeholder="제목을 입력하세요." name="title" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" id="productName" value="${productName}" readonly>
					</div>
				</div>
				<div class="form-group">
					<label for="inputId" class="col-sm-2 control-label">작성자</label>
					<div class="col-sm-10">
						<input class="form-control" id="inputId" value="${userid}" name="userid" readonly>
					</div>
				</div>								
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">	
						<button type="submit" class="btn btn-default submit">질문을 등록하기</button>
